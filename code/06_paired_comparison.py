...
##            instruments can be read against each other. The Atlas panels rest
##            on 114 responding countries and the GDO panels on 19-35, so
##            agreement between them is the main defence against the small-n
##            objection the country-level analysis would otherwise face.
...
## -- left panel: the aggregate instrument
ax = axes[0]
...
## -- right panel: the country-level instrument, same construct
ax = axes[1]
...
caption(fig,
        ...
        "the country-level finding is not an artefact of the 19-country sample. Sources: WHO/WFN Neurology Atlas 2nd ed. (2017) Fig. 12; WHO Global Dementia Observatory (2017) indicator GDO_q6x1_2.")
...
ax.set_title("A. Where neurologists practise — WHO Neurology Atlas\n"
...
fig.suptitle("Figure 7. Two instruments, one finding: specialist care thins out before it reaches rural populations",
             fontsize=13, y=0.985)
caption(fig,
        "Panel A asks whether neurologists practise in a setting at all; Panel B asks how far dementia diagnostic services extend. These are different questions about the same underlying\n"
